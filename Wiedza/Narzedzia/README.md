...
- DHCP i adresacja: [`Enable-DHCP.ps1`](Enable-DHCP.ps1), [`Get-DHCP.ps1`](Get-DHCP.ps1), [`IPv4-zakres.ps1`](IPv4-zakres.ps1), `ip-zakres`,
...
- VirtualBox: [`vbmk.ps1`](vbmk.ps1), `vbmk-freebsd`, `vb-alp`.
